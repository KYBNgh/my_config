...
PS1='$(EXIT_CODE=$?; if [[ $EXIT_CODE -ne 0 && $EXIT_CODE -ne 130 ]]; then echo "\[\033[1;38;5;15m\]$EXIT_CODE \[\033[0m\]";fi)\[\033[38;5;15m\]\u \[\033[0m\]\[\033[38;5;15m\]\[\033[0m\]\[\033[2;37;5m\]\W\[\033[0m\]\[\033[1;38;5;15m\]$(__git_ps1 " %s") \$\[\033[0m\] '
PS2='\[\033[2;37;5m\]>>\[\033[0m\] '
